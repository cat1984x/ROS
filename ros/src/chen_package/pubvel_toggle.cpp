// This program toggles between rotation sand trasition commands,
//based on calls to a service
//run after turtlesim_node 
...
int main(int argc,char **argv)
{
	...
	//Publish commands, using the latest value for forward, untill the node shuts down.
