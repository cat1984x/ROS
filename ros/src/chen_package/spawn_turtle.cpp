//This program spawns a new turtlesim turtle by calling the service
//run after roscore and turtlesim_node is running 
#include <ros/ros.h>
...
int main(int argc,char **argv)
{
	...
	//fill in the rqquest data members
	req.x = 2;
	req.y =3;
	req.theta = M_PI/2;
	req.name ="Leo";

	//actuall call the service.This won't return until the service is complete.
